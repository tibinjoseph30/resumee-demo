                    ...
                    <div className="flex gap-16 mt-4 border-b pb-4">
                        ...
                        <div>
                            <div className="flex items-center gap-2 text-sm text-slate-800">
                                ...
                                <Link href={`${accountsData?.githubUrl}`} target="_blank" className="text-slate-800">{formattedGithubUrl}</Link>
                            </div>
                            <div className="flex items-center gap-2 text-sm text-slate-800">
                                <svg
                                    viewBox="0 0 12 12"
                                ...
                                <Link href={`${accountsData?.linkedinUrl}`} target="_blank" className="text-slate-800">{formattedLinkedinUrl}</Link>
                            </div>
                        </div>
                    </div>
                    <div className="grid">

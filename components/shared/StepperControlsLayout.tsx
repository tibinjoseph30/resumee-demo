        ...
        <div className='fixed w-full bg-white flex bottom-0 left-0 h-20 border-t-1 border z-10'>
            ...
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className='flex sm:gap-4 gap-2 items-center justify-end flex-1'>
                    <button
                        type='button'
                        className='bg-gray-600 text-white p-3 rounded-md min-w-28 font-medium hover:opacity-90 hidden sm:block'
                    >
                        Reset
                    </button>
                    <button
                        type='button'
                        className='bg-gray-600 text-white p-3 rounded-md sm:hidden'
                    >
                        <HiArrowPath size={22} />
                    </button>
                    {children}

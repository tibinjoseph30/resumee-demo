    ...
    return (
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={{ paddingTop: 10, paddingBottom: 10, display: "flex", flexDirection: "row", gap: 30, borderBottom: "1px solid #ddd" }}>
                    <View>
                ...
                <View style={{ paddingTop: 10, paddingBottom: 10, borderBottom: "1px solid #ddd" }}>
                    <View>
                ...
                <View style={{ display: "flex", flexDirection: "row", height: 540 }}>

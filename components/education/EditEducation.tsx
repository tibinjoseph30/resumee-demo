...
const EditEducation = () => {
            ...
            const fetchEducationData = async () => {
                try {
                    ...
                    if (docSnap.exists()) {
                        ...
                        setMarksType(data.marksIn.toLowerCase())
    ...
    const handleUpdate = async (values: EducationForm) => {
        setLoading(true);
        try {
            if (user) {
                            ...
                            {pageLoading ? <Spinner size={32} /> :
                                (<div>
                                    ...
                                    <div className="flex sm:flex-row flex-col justify-end gap-3 mt-10">
                                        <button type="button" onClick={() => router.back()} className="border bg-slate-200 border-slate-300 p-3 rounded-md min-w-28 font-medium sm:w-auto w-full hover:border-slate-400">Cancel</button>
                                        <button
                                            type="submit"

...
import {
  ...
  setPageLoading,
  setReadOnly,
} from "../../store/user-type/userTypeSlice";
import {
  fetchUserData,
  submitUserData,
} from "../../store/user-type/userTypeThunk";
...
const UserType = () => {
  ...
  const { initialValues, isReadOnly, loading, error, pageLoading } =
    useSelector((state: RootState) => state.userType);
            ...
            {pageLoading ? (
              ...
              <div className="grid sm:grid-cols-2 gap-7">
                <div className="control-radio-container">
                  ...
                  >
                    ...
                    <div className="mt-4 text-slate-500">
                      If you are starting a new career or did&#39;nt work
                      anywhere yet! stay here
                    </div>
                ...
                <div className="control-radio-container">
                  ...
                  />
                  <label
                    htmlFor="user_experienced"
                    className="border-2 rounded-lg h-full"
                  >
                    <span className="text-lg font-semibold title">
                      I am an Expert{" "}
                      <span className="bg-pink-300/20 text-pink-900 text-sm font-normal px-3 py-1 rounded-md ms-2">
                        Most preffered
                      </span>
                    </span>
                    <div className="mt-4 text-slate-500">
                      If you have some experience in a field or looking for an
                      upgrade! go with this
                    </div>
                ...
                {isReadOnly ? (
                  <div className="flex sm:gap-4 gap-2">
                    <button
                      type="button"
                      onClick={handleEdit}
                      className="bg-slate-200 text-primary p-3 rounded-md min-w-28 font-medium hover:bg-slate-300 hidden sm:block"
                    >
                      Edit
                    </button>
                    <button
                      type="button"
                      onClick={handleEdit}
                      className="bg-slate-200 text-primary p-3 rounded-md sm:hidden"
                    >
